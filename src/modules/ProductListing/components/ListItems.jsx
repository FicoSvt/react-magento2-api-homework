...
const ListItems = (props) => {
    ...
    <span className="ui-list__inner-item ui-list__inner-item--products ui-list__price list-item-price">Price: <span className="price">{props.currency}{props.price}</span></span>
